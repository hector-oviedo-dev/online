...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_services_services__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_error_error__ = __webpack_require__(91);
        ...
        if (res.sections.length) {
            for (var i = 0; res.sections.length > i; i++) {
                if (res.sections[i].type) {
                    ...
                    this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__pages_error_error__["a" /* ErrorPage */], data_1);
                }
            }
        }
        else {
            var data_2 = { "MESSAGE": "Se esperaba array 'sections'" };
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__pages_error_error__["a" /* ErrorPage */], data_2);
        }
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_container_container__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_services_services__ = __webpack_require__(68);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var DynamicPage = (function () {
    ...
    DynamicPage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__providers_services_services__["a" /* ServicesProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__providers_services_services__["a" /* ServicesProvider */]) === "function" && _c || Object])
    ], DynamicPage);
    return DynamicPage;
    var _a, _b, _c;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_auto_input_auto_input__ = __webpack_require__(216);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_auto_textarea_auto_textarea__ = __webpack_require__(217);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_auto_date_auto_date__ = __webpack_require__(218);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_auto_select_auto_select__ = __webpack_require__(219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_auto_check_auto_check__ = __webpack_require__(220);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_auto_checklist_auto_checklist__ = __webpack_require__(221);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_auto_radio_auto_radio__ = __webpack_require__(222);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_services_services__ = __webpack_require__(68);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AutoFormComponent = (function () {
    function AutoFormComponent(componentFactoryResolver, services, fb) {
        this.componentFactoryResolver = componentFactoryResolver;
        this.services = services;
        this.components = [];
        this.values = [];
        this.complexForm = fb.group({
            'name': [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].minLength(5), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].maxLength(20)])]
        });
    }
    ...
    AutoFormComponent.prototype.addInput = function (value) {
        ...
        var componentFactory = this.componentFactoryResolver.resolveComponentFactory(__WEBPACK_IMPORTED_MODULE_2__components_auto_input_auto_input__["a" /* AutoInputComponent */]);
        var component = this.container.createComponent(componentFactory);
    ...
    AutoFormComponent.prototype.addTextarea = function (value) {
        var componentFactory = this.componentFactoryResolver.resolveComponentFactory(__WEBPACK_IMPORTED_MODULE_3__components_auto_textarea_auto_textarea__["a" /* AutoTextareaComponent */]);
        var component = this.container.createComponent(componentFactory);
        component.instance._ID = value.id;
        component.instance._value = value.value;
        component.instance._hidden = value.hidden;
    ...
    AutoFormComponent.prototype.addDate = function (value) {
        var componentFactory = this.componentFactoryResolver.resolveComponentFactory(__WEBPACK_IMPORTED_MODULE_4__components_auto_date_auto_date__["a" /* AutoDateComponent */]);
        var component = this.container.createComponent(componentFactory);
        component.instance._ID = value.id;
        component.instance._value = value.value;
        component.instance._hidden = value.hidden;
    ...
    AutoFormComponent.prototype.addCheckbox = function (value) {
        var componentFactory = this.componentFactoryResolver.resolveComponentFactory(__WEBPACK_IMPORTED_MODULE_6__components_auto_check_auto_check__["a" /* AutoCheckComponent */]);
        var component = this.container.createComponent(componentFactory);
        component.instance._ID = value.id;
        component.instance._value = value.value;
        component.instance._hidden = value.hidden;
    ...
    AutoFormComponent.prototype.addCheckboxlist = function (value) {
        var componentFactory = this.componentFactoryResolver.resolveComponentFactory(__WEBPACK_IMPORTED_MODULE_7__components_auto_checklist_auto_checklist__["a" /* AutoChecklistComponent */]);
        var component = this.container.createComponent(componentFactory);
        component.instance._ID = value.id;
        component.instance._hidden = value.hidden;
        component.instance._enabled = value.enabled;
    ...
    AutoFormComponent.prototype.addRadio = function (value) {
        var componentFactory = this.componentFactoryResolver.resolveComponentFactory(__WEBPACK_IMPORTED_MODULE_8__components_auto_radio_auto_radio__["a" /* AutoRadioComponent */]);
        var component = this.container.createComponent(componentFactory);
        component.instance._ID = value.id;
        component.instance._hidden = value.hidden;
        component.instance._enabled = value.enabled;
    ...
    AutoFormComponent.prototype.addSelect = function (value) {
        var componentFactory = this.componentFactoryResolver.resolveComponentFactory(__WEBPACK_IMPORTED_MODULE_5__components_auto_select_auto_select__["a" /* AutoSelectComponent */]);
        var component = this.container.createComponent(componentFactory);
        component.instance._ID = value.id;
        component.instance._value = value.value;
        component.instance._hidden = value.hidden;
    ...
    AutoFormComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'auto-form',template:/*ion-inline-start:"D:\git\online\src\components\auto-form\auto-form.html"*/'<form [formGroup]="complexForm">\n<ion-grid>\n\n  <ion-row>\n  <ion-col>\n    <br>\n    <ion-header>\n\n        <ion-title>{{_label_title}}</ion-title>\n        <br>\n\n    </ion-header>\n    <br>\n  </ion-col>\n  </ion-row>\n  <ion-row>\n  <ion-col>\n    <ng-template #container>\n    </ng-template>\n  </ion-col>\n  </ion-row>\n\n  <ion-row>\n  <ion-col>\n    <button ion-button [disabled]="complexForm.valid" (click)="submitClick()">{{_label_submit}}</button>\n  </ion-col>\n  <ion-col>\n    <button ion-button>{{_label_cancel}}</button>\n  </ion-col>\n  </ion-row>\n</ion-grid>\n</form>\n'/*ion-inline-end:"D:\git\online\src\components\auto-form\auto-form.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* ComponentFactoryResolver */], __WEBPACK_IMPORTED_MODULE_9__providers_services_services__["a" /* ServicesProvider */], __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormBuilder */]])
    ], AutoFormComponent);
...
var AutoInputComponent = (function () {
    function AutoInputComponent(_fb) {
        this._fb = _fb;
        this._restrict = [];
        this._display = [];
    }
...
var AutoTextareaComponent = (function () {
    function AutoTextareaComponent(_fb) {
        this._fb = _fb;
        this._min = 0;
        this._max = 50;
        this._restrict = [];
...
var AutoChecklistComponent = (function () {
    function AutoChecklistComponent() {
        this._options = [];
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_bridge_bridge__ = __webpack_require__(225);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var OnlinePage = (function () {
    ...
    OnlinePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_bridge_bridge__["a" /* BridgeProvider */]])
    ], OnlinePage);
    return OnlinePage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_auto_menu_auto_menu__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_auto_input_auto_input__ = __webpack_require__(216);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_auto_textarea_auto_textarea__ = __webpack_require__(217);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_auto_date_auto_date__ = __webpack_require__(218);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_auto_select_auto_select__ = __webpack_require__(219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_auto_check_auto_check__ = __webpack_require__(220);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_auto_checklist_auto_checklist__ = __webpack_require__(221);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_auto_radio_auto_radio__ = __webpack_require__(222);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_auto_form_auto_form__ = __webpack_require__(215);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_auto_grid_auto_grid__ = __webpack_require__(370);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_home_home__ = __webpack_require__(371);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_error_error__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_mainmenu_mainmenu__ = __webpack_require__(157);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_online_online__ = __webpack_require__(307);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_dynamic_dynamic__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_container_container__ = __webpack_require__(155);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__providers_bridge_bridge__ = __webpack_require__(225);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24_ionic_tooltips__ = __webpack_require__(372);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__angular_platform_browser_animations__ = __webpack_require__(374);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__angular_material__ = __webpack_require__(376);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__progress_kendo_angular_buttons__ = __webpack_require__(426);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__providers_services_services__ = __webpack_require__(68);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_16__pages_error_error__["a" /* ErrorPage */],
                __WEBPACK_IMPORTED_MODULE_17__pages_mainmenu_mainmenu__["a" /* MainmenuPage */],
                __WEBPACK_IMPORTED_MODULE_18__pages_online_online__["a" /* OnlinePage */],
                __WEBPACK_IMPORTED_MODULE_19__pages_dynamic_dynamic__["a" /* DynamicPage */],
                __WEBPACK_IMPORTED_MODULE_20__pages_container_container__["a" /* ContainerPage */],
                ...
                __WEBPACK_IMPORTED_MODULE_10__components_auto_check_auto_check__["a" /* AutoCheckComponent */],
                __WEBPACK_IMPORTED_MODULE_11__components_auto_checklist_auto_checklist__["a" /* AutoChecklistComponent */],
                __WEBPACK_IMPORTED_MODULE_12__components_auto_radio_auto_radio__["a" /* AutoRadioComponent */],
                __WEBPACK_IMPORTED_MODULE_13__components_auto_form_auto_form__["a" /* AutoFormComponent */],
                __WEBPACK_IMPORTED_MODULE_14__components_auto_grid_auto_grid__["a" /* AutoGridComponent */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_24_ionic_tooltips__["a" /* TooltipsModule */],
                __WEBPACK_IMPORTED_MODULE_25__angular_platform_browser_animations__["a" /* BrowserAnimationsModule */],
                __WEBPACK_IMPORTED_MODULE_27__progress_kendo_angular_buttons__["a" /* ButtonsModule */],
                __WEBPACK_IMPORTED_MODULE_26__angular_material__["b" /* MatInputModule */], __WEBPACK_IMPORTED_MODULE_26__angular_material__["c" /* MatProgressSpinnerModule */], __WEBPACK_IMPORTED_MODULE_26__angular_material__["a" /* MatCardModule */]
            ],
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_23__providers_bridge_bridge__["a" /* BridgeProvider */],
                __WEBPACK_IMPORTED_MODULE_28__providers_services_services__["a" /* ServicesProvider */]
            ]
        })
    ], AppModule);
    return AppModule;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_services_services__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__error_error__ = __webpack_require__(91);
...
var HomePage = (function () {
    ...
    HomePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["b" /* FormBuilder */], __WEBPACK_IMPORTED_MODULE_3__providers_services_services__["a" /* ServicesProvider */]])
    ], HomePage);
    return HomePage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_common_http__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_catch__ = __webpack_require__(344);
...
var ServicesProvider = (function () {
    ...
    ServicesProvider.prototype.setContent = function (content) { this._content = content; };
    ServicesProvider.prototype.getContent = function () { return this._content; };
